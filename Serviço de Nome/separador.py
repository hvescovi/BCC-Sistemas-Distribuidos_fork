...
FILE_NAME = "companies_sorted.csv"                              # Endereço do arquivo para particionamento e armazenamento em arquivos de texto
N_DIR = 12                                                      # Quantidade de diretórios para o particionamento
...
with open(FILE_NAME, "r") as file:                              # Ler arquivo
